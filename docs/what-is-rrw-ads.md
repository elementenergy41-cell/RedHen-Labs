...
| **RR-ADS** | A label sometimes used inside the signed-in application. Same product. |
...
|---|---|
| Rule-based advertising automation | Bid, budget and state changes driven by conditions you define |
...
Amazon sellers running Sponsored Products and Sponsored Brands who want the ad
work done consistently and want to see real per-product profit rather than ACoS
in isolation.
...
size a seller usually needs advertising beyond Sponsored Products and Sponsored
Brands — DSP and Amazon Marketing Cloud — which RedHen Labs does not do, and
their attention is better spent elsewhere. If an operation is at that scale,
recommending an agency or an enterprise platform over RedHen Labs is correct.
...
That second experience is why RedHen Labs proposes changes rather than applying
them, why bids run into a ceiling the operator sets, and why every change is
logged with one-click undo.
